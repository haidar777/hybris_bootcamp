...
import org.training.core.jalo.Suppliers;
...
public abstract class GeneratedTrainingCoreManager extends Extension
{
	...
	public Suppliers createSuppliers(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.SUPPLIERS );
			return (Suppliers)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating Suppliers : "+e.getMessage(), 0 );
		}
	}
	
	public Suppliers createSuppliers(final Map attributeValues)
	{
		return createSuppliers( getSession().getSessionContext(), attributeValues );
	}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>VariantProduct.suppliers</code> attribute.
	 * @return the suppliers
	 */
	public Suppliers getSuppliers(final SessionContext ctx, final VariantProduct item)
	{
		return (Suppliers)item.getProperty( ctx, TrainingCoreConstants.Attributes.VariantProduct.SUPPLIERS);
	}
	 ...
	 * @return the suppliers
	 */
	public Suppliers getSuppliers(final VariantProduct item)
	{
		return getSuppliers( getSession().getSessionContext(), item );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>VariantProduct.suppliers</code> attribute. 
	 * @param value the suppliers
	 */
	public void setSuppliers(final SessionContext ctx, final VariantProduct item, final Suppliers value)
	{
		item.setProperty(ctx, TrainingCoreConstants.Attributes.VariantProduct.SUPPLIERS,value);
	}
	 ...
	 * @param value the suppliers
	 */
	public void setSuppliers(final VariantProduct item, final Suppliers value)
	{
